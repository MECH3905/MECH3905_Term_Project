...
T = image(ball,'XData',[x(1)-scale*a_img/2 x(1)+scale*a_img/2], 'YData',[y(1)-scale*b_img/2+10 y(1)+scale*b_img/2+10], 'AlphaData',alpha); 
% ----- Debug Text -----
...
while ishandle(H)
    ...
    set(T,'XData',[x(1)-scale*a_img/2 x(1)+scale*a_img/2],'YData',[y(1)-scale*b_img/2+15+5*c y(1)+scale*b_img/2+15+5*c]);
    % ----- Update Debug Text -----
